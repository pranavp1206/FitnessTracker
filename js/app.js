  ...
  return (
    <Modal title={<>JOIN MY<span style={{ color: "var(--accent)" }}>FITNESS</span></>} sub="Create your account to start tracking" onClose={() => { }}>
      <form onSubmit={submit} style={{ display: "flex", flexDirection: "column" }}>
        ...
        <div className="row2">
          <Field label="First Name" placeholder="Fname" value={f.fname} onChange={set("fname")} />
          <Field label="Last Name" placeholder="Lname" value={f.lname} onChange={set("lname")} />
        </div>
        <Field label="Email" type="email" placeholder="name@email.com" value={f.email} onChange={set("email")} />
...
function LoginModal({ onLogin, onSwitch }) {
  ...
  return (
    <Modal title={<>WELCOME<span style={{ color: "var(--accent)" }}> BACK</span></>} sub="Sign in to continue" onClose={() => { }}>
      <form onSubmit={submit} style={{ display: "flex", flexDirection: "column" }}>
        {err && <div className="err">{err}</div>}
        <Field label="Email" type="email" placeholder="name@email.com" value={email} onChange={e => setEmail(e.target.value)} />
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: 20 }}>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 20 }}>
            <form className="card" onSubmit={submit} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              ...
              <Field label="Your Name" placeholder="Your Name" value={name} onChange={e => setName(e.target.value)} />
              <Field label="Email Address" type="email" placeholder="name@email.com" value={email} onChange={e => setEmail(e.target.value)} />
              <div className="field">
                <label>Message</label>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              <div className="card">
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 10, fontSize: ".9rem" }}>
                  ...
                  <a href="https://github.com/pranavp1206/FitnessTracker" style={{ color: "var(--accent)", textDecoration: "none" }}>GitHub Repository</a>
                </div>
              </div>
              <div className="card">
      ...
      <div className="landing" style={{ minHeight: "calc(100vh - 58px)", padding: "40px 20px" }}>
        ...
        <div style={{ marginTop: 40, borderTop: "1px solid var(--border)", paddingTop: 40, width: "100%", maxWidth: 600 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 20, textAlign: "left" }}>
            <div className="card">
              <div style={{ fontWeight: 600, color: "var(--accent)" }}>Harishankar</div>
              <div style={{ fontSize: ".85rem", color: "var(--muted)" }}>Frontend Developer</div>
            </div>
            <div className="card">
              <div style={{ fontWeight: 600, color: "var(--accent)" }}>Sreegovind</div>
              <div style={{ fontSize: ".85rem", color: "var(--muted)" }}>Frontend Developer</div>
            </div>
            <div className="card">
              <div style={{ fontWeight: 600, color: "var(--accent)" }}>Maheswar</div>
              <div style={{ fontSize: ".85rem", color: "var(--muted)" }}>Frontend Develope</div>
            </div>
            <div className="card">
              <div style={{ fontWeight: 600, color: "var(--accent)" }}>Navdeep</div>
              <div style={{ fontSize: ".85rem", color: "var(--muted)" }}>Frontend Develope</div>
            </div>
            <div className="card">
              <div style={{ fontWeight: 600, color: "var(--accent)" }}>Pranav</div>
              <div style={{ fontSize: ".85rem", color: "var(--muted)" }}>Frontend Develope</div>
            </div>
          </div>
        </div>
